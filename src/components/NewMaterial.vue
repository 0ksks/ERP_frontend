                  ...
                  <el-row :gutter="20">
                    ...
                    <el-col :span="8">
                      <el-form-item label="MRP Controller:">
                        <el-input v-model="selectedMaterial.mrpTController" class="text-value"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  ...
                  <el-row :gutter="20">
                    ...
                    <el-col :span="8">
                      <el-form-item label="Price Unit:">
                        <el-input v-model="selectedMaterial.pricUnit" class="text-value"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
  ...
  export default {
    setup() {
      ...
      async function saveMaterial() {
        ...
        try {
          // 发送请求保存供应商数据
          const response = await axios.post('/api/material/create_success', form.value);
  
          if (response.data.code === 1) {
            ElMessageBox.alert(`Material created successfully! Material ID: ${response.data.data.materialID}`, 'Success', {
              confirmButtonText: 'OK',
              type: 'success',
            });
            // 清空表单
            ...
            ElMessageBox.alert('Failed to create material. Please try again.', 'Error', {
              confirmButtonText: 'OK',
              type: 'error',
            });
          }
